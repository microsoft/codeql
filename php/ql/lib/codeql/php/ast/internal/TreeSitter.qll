...
overlay[local] module Php { 
  ...
  /** A class representing `php_end_tag` tokens. */class PhpEndTag extends @php_token_php_end_tag, Token { 
  ...
  /** A class representing `relative_name` nodes. */class RelativeName extends @php_relative_name, AstNode { 
