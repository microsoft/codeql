...
// Generated from `Azure.Storage.Blobs.ChangeFeed, Version=12.0.0.0-preview.54, Culture=neutral, PublicKeyToken=92742159e12e44c8`.
namespace Azure
{
    namespace Storage
    {
        namespace Blobs
        {
            namespace ChangeFeed
            {
                ...
                {
                    protected BlobChangeFeedClient() => throw null;
                    public BlobChangeFeedClient(string connectionString) => throw null;
                    public BlobChangeFeedClient(string connectionString, Azure.Storage.Blobs.BlobClientOptions options, Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClientOptions changeFeedOptions) => throw null;
                    public BlobChangeFeedClient(System.Uri serviceUri, Azure.Storage.Blobs.BlobClientOptions options = default(Azure.Storage.Blobs.BlobClientOptions), Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClientOptions changeFeedOptions = default(Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClientOptions)) => throw null;
                    public BlobChangeFeedClient(System.Uri serviceUri, Azure.Storage.StorageSharedKeyCredential credential, Azure.Storage.Blobs.BlobClientOptions options = default(Azure.Storage.Blobs.BlobClientOptions), Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClientOptions changeFeedOptions = default(Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClientOptions)) => throw null;
                    public BlobChangeFeedClient(System.Uri serviceUri, Azure.AzureSasCredential credential, Azure.Storage.Blobs.BlobClientOptions options = default(Azure.Storage.Blobs.BlobClientOptions), Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClientOptions changeFeedOptions = default(Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClientOptions)) => throw null;
                    public BlobChangeFeedClient(System.Uri serviceUri, Azure.Core.TokenCredential credential, Azure.Storage.Blobs.BlobClientOptions options = default(Azure.Storage.Blobs.BlobClientOptions), Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClientOptions changeFeedOptions = default(Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClientOptions)) => throw null;
                ...
                {
                    public BlobChangeFeedClientOptions() => throw null;
                ...
                public struct BlobChangeFeedEventType : System.IEquatable<Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedEventType>
                {
                ...
                {
                    public static Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClient GetChangeFeedClient(this Azure.Storage.Blobs.BlobServiceClient serviceClient, Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClientOptions options = default(Azure.Storage.Blobs.ChangeFeed.BlobChangeFeedClientOptions)) => throw null;
                }
                ...
                public struct BlobOperationName : System.IEquatable<Azure.Storage.Blobs.ChangeFeed.BlobOperationName>
                {
